    ...
    <div>
      ...
      <div className="p-6 space-y-5 max-w-[1400px]">
        <div className="flex items-center justify-between flex-wrap gap-3">
          <div>
            <h2 className="text-lg font-semibold tracking-tight">Meta — Instagram y Facebook</h2>
            <p className="text-sm text-muted">Seguidores, contenidos y rendimiento de tus 3 marcas</p>
          </div>
